...
public class SEProvider {
  ...
  // Following three parameters will change for JCOP.
  // e,g MAX_SCRATCH_SIZE = 512, MAX_BUFFER_SIZE = 2048 and AES_GCM_BUFFERING = true.
  public static final short MAX_SCRATCH_SIZE = 30000;
  public static final short MAX_BUFFER_SIZE = 30000;
  public static final boolean AES_GCM_BUFFERING = false;
