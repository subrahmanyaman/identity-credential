...
public class DocumentRequest {
     ...
     * DeviceNameSpacesBytes ; Same as in mdoc response ] The Mac Tag generated by digesting the
     * data is then appended to CoseMac0 structure defined in COSE_MAC0_STRUCT during presentation.
     */
    ...
    private static final byte[] SIGN1_Signature1 = {0x6A, 0x53, 0x69, 0x67, 0x6E, 0x61,
                                                    0x74, 0x75, 0x72, 0x65, 0x31};
    // alg = -7
    ...
    boolean init(MdocPresentationPkg doc, Session session, byte[] buf, short nameSpacesStart,
        ...
        for (short i = 0; i < numElements; i++) {
            ...
            for (short j = 0; j < dataElemCount; j++) {
                ...
                mDecoder
                    .skipEntry();  // skip the requested element value - this is the intentToRetain
            }
