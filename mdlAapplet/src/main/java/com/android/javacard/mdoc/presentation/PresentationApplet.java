 ...
 */
package com.android.javacard.mdoc.presentation;
...
import com.android.javacard.mdoc.CBOREncoderCalc;
import com.android.javacard.mdoc.MdlPresentationPkgStore;
import com.android.javacard.mdoc.MdlService;
    ...
    private void processGetResponse(APDU apdu, boolean firstMessage) {
        ...
        while (index < mContext.mChunkSize[0]) {
            ...
            if (mContext.mBufReadIndex[0] < mContext.mBufWriteIndex[0]) {
                ...
                short remBytes =
                    (short)(mContext.mRemainingBytes[0] + mContext.mBufWriteIndex[0] -
                            mContext.mBufReadIndex[0] +
                            mSession.mBuffer[Session.BUF_LENGTH_OFFSET] +
                            SEProvider.AES_GCM_TAG_LENGTH + mSession.mAesGcmInternalBufferLen[0]);
