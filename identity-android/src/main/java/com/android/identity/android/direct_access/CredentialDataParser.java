...
public class CredentialDataParser {
  ...
  public static PublicKey validateIssuerAuth(String expectedDocType, DataItem credentialDataItem,
    ...
    PublicKey issuerAuthorityKey = issuerAuthorityCertChain.iterator().next().getPublicKey();

    boolean issuerSignedAuthenticated = Util.coseSign1CheckSignature(issuerAuthDataItem, null,
        issuerAuthorityKey);
    Logger.d("CredentialDataParser", "issuerSignedAuthenticated: " + issuerSignedAuthenticated);
