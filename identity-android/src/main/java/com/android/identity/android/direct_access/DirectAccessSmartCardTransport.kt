...
import com.android.identity.util.HexUtil.fromHex
 ...
 */
class DirectAccessSmartCardTransport : DirectAccessTransport {
    init {
        instance()
    }
